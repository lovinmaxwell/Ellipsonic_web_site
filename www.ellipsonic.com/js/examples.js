...
$(".container3").mapael({
		...
		plots : {
			...
			'London' : {
				...
				fill : "#d9534f",
				value : 0, 
				text: {content : "London" ,position : 'left', margin:5 ,fill: "#d9534f"}
			},
		   'Muscat' : {
				latitude :23.6100, 
				longitude :58.5400, 
			...
			'Dubai ' : {
				...
				longitude :55.2708, 
				value : 600000, 
				text: {content : "Dubai" ,position : 'top', margin:5 ,fill: "#d9534f"}
			},
            'Dallas ' : {
				latitude :32.7833333, 
				longitude :-96.8, 
			...
			'Oman': {
				...
				value : 200001, 
				fill : "#1a527b",
				text: {content : "Oman"  ,position : 'left', margin:5 ,fill: "#d9534f"}
			},
            'Banglore': {
				latitude :12.9667, 
				longitude :77.5667, 
